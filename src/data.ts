...
export const experiences = [
  {
    ...
    url: "https://www.technestdigital.com",
  },
  {
    id: 2,
    image: "",
...
export const educations = [
  ...
  },
  {
    ...
    period: "2012 - 2022",
    url: "https://www.gnfps.org", // Replace with actual URL if different
  },
];
...
export const projects = [
  ...
  {
    id: 2,
    image: "grocery_img.png",
    title: "Grocery Store Frontend",
    description:
      "Built an intuitive and responsive grocery store frontend with React and TailwindCSS. Includes dynamic product listings, shopping cart, and seamless API integration using Node.js for data fetching.",
    techStack: ["HTML", "CSS", "React", "Node.js", "TailwindCSS"],
    websiteUrl: "https://grocery-store-wheat.vercel.app/",
    sourceUrl: "https://github.com/ishaangupta122/GroceryStore.git",
  },
  {
    id: 3,
    image: "courses_img.png",
  ...
  },
  {
    ...
    techStack: ["React", "Node.js", "TailwindCSS", "News API", "Search Query"],
